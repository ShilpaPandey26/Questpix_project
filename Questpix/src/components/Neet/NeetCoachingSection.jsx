...
export default function NeetCoachingSection() {
  return (
    <section className="container text-white pt-40 flex flex-col md:flex-row items-center md:justify-between">
      
      {/* Left Content */}
      <div className="max-w-xl">
        <h2 className="text-3xl md:text-4xl font-bold leading-snug">
          Learn From The Legend Who <br />
          <span className="text-[#2FC18B]">Shaped Kota Coaching.</span>
        </h2>
        <p className="mt-4 text-[#9EBDEF]">
          Imagine learning from the very best, a teacher who has not only 
          witnessed the evolution of JEE/NEET coaching but has been instrumental 
          in shaping it.
        </p>
        <p className="mt-4 text-[#9EBDEF]">
