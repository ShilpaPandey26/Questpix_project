...
const faqs = [
    {
        ...
        answer:
            "Our faculty includes experienced educators with proven track records in NEET coaching, led by Vijay Sharma Sir, who has over 21 years of experience at top Kota institutes.",
    },
    {
    ...
    {
        question: "Is this app suitable for all NEET aspirants?",
...
export default function NeetFAQSection() {
