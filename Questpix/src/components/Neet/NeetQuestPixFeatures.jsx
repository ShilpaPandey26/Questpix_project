...
const features = [
    ...
    },
    {
        ...
        description:
            "Practice with a vast collection of NEET UG PYQs, categorized by subject and year.",
        bg: "bg-[#1b283d]",
    ...
    },
    {
        ...
        description:
            "Use our Rank Prediction Tool to estimate your NEET rank based on your performance.",
          bg: "bg-[#1b283d]",
    ...
    return (
        <div className="py-10 px-4 text-center">
            ...
            <p className="text-[#d0d2d4] mt-2 max-w-2xl mx-auto">
                Experience the power of new-age NEET prep without spending anything.
            </p>
