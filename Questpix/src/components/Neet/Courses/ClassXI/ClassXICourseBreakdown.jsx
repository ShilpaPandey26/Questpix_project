...
export default function ClassXICourseBreakdown() {
  const sections = [
    {
    ...
    },
    {
      ...
      points: [
        ...
        "Expert faculties with 15+ years of average experience.",
        "Concise, focused curriculum designed for efficient NEET UG preparation.",
      ],
