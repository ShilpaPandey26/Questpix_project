...
export default function ClassXIIPlusFeaturesSection() {
  const sections = [
    {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-12">
      ...
      <p className="text-[15px] text-center mt-6 pb-20  mx-auto">
        Choosing the right online NEET coaching can be tough. Understand how
