    ...
    <div className="container mx-auto  pt-30 flex flex-col md:flex-row items-center md:justify-between">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-2 text-center md:text-left ">
        <h3 className="text-2xl font-extrabold">
          Your <span className="text-[#2FC18B]">Final Chance To AIIMS  </span> Starts With Our
        </h3>
        <h2 className="text-2xl sm:text-5xl  font-extrabold">
          <span className="text-[#2FC18B]">1-Years </span> Program
        </h2>
        ...
        <p className="text-[15px]  mt-4 text-[#9EBDEF] ">
          ...
          <span className="text-white"> NEET UG.</span>
        </p>
