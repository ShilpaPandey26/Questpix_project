...
export default function SixTestimonials() {
 ...
 useEffect(() => {
  ...
  return (
    <div className="w-[1150px] mx-auto relative left-8 mb-20">
      <h2 className="text-4xl mb-15 font-bold mx-auto text-center w-[55%]">Hear From
        <span className="text-[#2FC18B]"> Happy Students </span>& Parents
Who Trust QuestPix
      </h2>
