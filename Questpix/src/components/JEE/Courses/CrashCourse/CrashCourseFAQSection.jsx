...
const faqs = [
  {
    question: "What is the duration of the JEE  prep programs?",
    answer:
  ...
  {
    question: "Does the app provide study material for other competitive exams besides JEE?",
    answer: "While our primary focus is JEE, the skills and concepts you learn will be beneficial for other competitive exams like BITSAT, VITEEE, etc.",
  },
  {
...
export default function CrashCourseFAQSection() {
