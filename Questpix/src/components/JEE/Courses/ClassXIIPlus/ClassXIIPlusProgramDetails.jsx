...
import details from "../../../../assets/jee-images/courses/details.png";

export default function ClassXIIPlusProgramDetails() {
  const features = [
    {
      title: "Kota’s Best Faculty",
      desc: "90% of our faculty are IIT alumni with an average of 15+ years teaching experience at top institutes.",
    ...
    },
    {
      ...
      desc: "1000+ hours of rigorous teachings covering the entire JEE syllabus, including 300+ hours dedicated to concept building and consolidation.",
