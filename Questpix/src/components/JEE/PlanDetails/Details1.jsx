                ...
                <div className="flex flex-col lg:flex-row gap-10 xl:gap-16 pt-20 sm:pt-30">
                    ...
                    <div className="lg:w-[65%]">
                        ...
                        <ul className="text-[#9EBDEF] mb-6 space-y-3 text-sm sm:text-base list-disc px-4">
                            <li>
                                <span className="font-bold">Focused JEE Main FST Prep:</span>{" "}
                                Concentrate on full syllabus tests for JEE Main mastery.
                            </li>
                            <li>
                                <span className="font-bold">JEE Main FSTs (12): </span>Benefit
                                from 12 dedicated full syllabus tests for JEE Main exam.
                            </li>
                            <li>
                                <span className="font-bold">JEE Adv. FSTs (3): </span> Benefit
                                from 3 dedicated full syllabus tests for JEE Adv. exam.
                            </li>
                            <li>
                                <span className="font-bold">
                                    Past JEE Main Papers (Unlimited):
                                </span>{" "}
                                Practice past papers unlimited times for exam familiarization.
                            </li>
                            <li>
                                <span className="font-bold">Budget-Friendly FST Approach:</span>{" "}
                                Value option focused on core JEE Main full syllabus practice.
                            </li>
                            <li>
                                <span className="font-bold">
                                    Ideal for Core JEE Main Readiness:
                                </span>{" "}
                                Perfect for achieving proficiency in JEE Main syllabus.
                            </li>
                            <li>
                                <span className="font-bold">Sufficient FST Practice:</span>{" "}
                                Solid JEE Main foundation through concentrated full syllabus
                                tests.
                            </li>
                        </ul>
                            ...
                            <div className="border border-gray-700 p-3 rounded-lg">
                                <ul className="text-[#9EBDEF] space-y-2 text-sm sm:text-base">
                                    ...
                                    <li>
                                        ...
                                        <span className="text-white font-semibold">Rs. 899.00</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
