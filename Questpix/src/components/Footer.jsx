...
export default function Footer() {
  return (
    <div className="bg-[#080e16] text-white">
      <div className="container mx-auto px-4 py-10 flex flex-col lg:flex-row justify-between gap-10 lg:gap-0 ">
        ...
        <div className="w-full mx-auto px-4 py-10 flex flex-col lg:flex-row justify-between gap-10 lg:gap-0">
          ...
          <div className="flex flex-col items-start gap-5 w-full lg:w-[40%] ">
            <img
              ...
              className="h-20"
            />
            <p className="text-[rgba(255,255,255,0.6)] text-[16px] font-medium w-full lg:w-[85%]">
              We are a team of passionate faculties, technologists, and innovators,
              led by the very best Vijay Sharma Sir at the helm, dedicated to
              revolutionizing JEE, NEET and Foundation preparation by making it
              more accessible, personalized, and engaging.
            </p>
          ...
          <div className="flex flex-col w-full md:w-[40%] lg:w-[25%]">
            ...
            <ul className="text-[16px] text-[rgba(255,255,255,0.6)] list-disc list-inside space-y-1">
              {[
                "JEE",
                "NEET",
                "Class 6 - 10",
          ...
          <div className="flex flex-col w-full md:w-[60%] lg:w-[33.33%]">
            ...
            <h3 className="text-lg font-semibold mt-6 mb-4">Download Our App</h3>
      ...
      {/* Copyright */}
      <div className="flex justify-center items-center p-5 text-[15px] bg-[#070b13]">
